...
export const menuData = {
  ...
  meats: [
    // --- Ternera ---
    { id: 16, name: { es: 'Ojo de bife (450g)', en: 'Rib eye steak (1 lbs)' }, price: 36000, featured: true, category: 'Ternera' },
    { id: 17, name: { es: 'Bife de chorizo (450g)', en: 'New York strip loin (1 lbs)' }, price: 33000, category: 'Ternera' },
    { id: 18, name: { es: 'Babe bife de chorizo (280g)', en: 'Petite NY Strip loin (1/2 lbs)' }, price: 26000, category: 'Ternera' },
    { id: 19, name: { es: 'Babe ojo de bife (280g)', en: 'Petite rib eye steak (1/2 lbs)' }, price: 26000, category: 'Ternera' },
    { id: 20, name: { es: 'Medallón de lomo (450g)', en: 'Beef tenderloin (1 lbs)' }, price: 40000, category: 'Ternera' },
    { id: 21, name: { es: 'Bife de Costilla/Tomahawk (550g)', en: 'Tomahawk (1.8 lbs)' }, price: 45000, featured: true, category: 'Ternera' },
    // --- Carnes Maduradas ---
    { id: 22, name: { es: 'Carnes Maduradas: Bife de costilla/Tomahawk (550g)', en: 'Dry age steak: Tomahawk (1.8 lbs)' }, description: { es: 'Curación lenta y controlada de temperatura, humedad y circulación de aire.', en: 'Slow and controlled curing process.' }, price: 60000, category: 'Carnes Maduradas' },
    { id: 23, name: { es: 'Carnes Maduradas: Bife de chorizo (450g)', en: 'Dry age steak: New York strip loin (1 lbs)' }, price: 45000, category: 'Carnes Maduradas' },
    // --- Parrilladas Mixtas ---
    { id: 24, name: { es: 'Parrillada de Mar c/guarnición (2p)', en: 'Mix Grilled Seafood with side dish (2p)' }, description: { es: 'Pulpo, langostinos, salmón, vieira, centolla. Acompañado de puré mixto y ensalada.', en: 'Octopus, prawn, salmon, scallop, crab with mixed puree and salad.' }, price: 110000, category: 'Parrilladas Mixtas' },
    { id: 25, name: { es: 'Mix de carnes c/guarnición (2p)', en: 'Mix of Meats with side dish(2p)' }, description: { es: 'Ternera 200g, Cerdo 200g, Cordero 200g, Pollo 200g, Guanaco 200g, acompañado de papas fritas y ensalada.', en: 'Beef 200 g, Pork 200 g, Lamb 200 g, Chicken 200g. Guanaco 200g with french fries and salad.' }, price: 93000, category: 'Parrilladas Mixtas' },
    // --- Cerdo ---
    { id: 26, name: { es: 'Bife de bondiola pintada (450g)', en: 'Pork shoulder fillet (1 lbs)' }, description: { es: 'Con mostaza y chutney.', en: 'With mustard and chutney.' }, price: 26000, category: 'Cerdo' },
    { id: 27, name: { es: 'Matambrito de cerdo', en: 'Pork flank steak' }, price: 26000, category: 'Cerdo' },
    // --- Cordero ---
    { id: 28, name: { es: 'Porción de cordero (Costilla y pata)', en: 'Lamb (Rack, leg and shoulder of lamb)' }, price: 33000, category: 'Cordero' },
    // --- Pescado ---
    { id: 29, name: { es: 'Salmón rosado', en: 'Salmon steak' }, price: 38000, category: 'Pescado' },
    { id: 30, name: { es: 'Trucha', en: 'Trout' }, price: 32000, category: 'Pescado' },
    // --- Guanaco ---
    { id: 31, name: { es: 'Bife de Guanaco (450g)', en: 'Guanaco steak (1 lbs)' }, price: 30000, category: 'Guanaco' },
  ],
